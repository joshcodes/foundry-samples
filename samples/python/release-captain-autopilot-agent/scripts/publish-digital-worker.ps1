...
$body = @{
    ...
    appVersion          = "1.0.0"
    shortDescription    = "Release Captain — release-coordination AI teammate for NotARealCo Checkout."
    fullDescription     = "Release Captain offloads the coordination paperwork around a release so feature PMs and engineers can focus on shipping. It runs the daily readiness digest, chases gate-evidence owners, drafts merchant + exec communications, builds go/no-go and retro meeting artifacts, logs decisions to the pinned readiness doc, schedules releases, and pattern-matches risk against prior release history. Deployed as a Foundry A365 autopilot agent."
    developerName       = "NotARealCo"
